package me.fergs.phantomvouchers.inventories.impl.pagination;



import me.fergs.phantomvouchers.inventories.impl.FastInv;
...
public class PaginatedFastInv extends FastInv {
    ...
    public void openPage(int page) {
        ...
        if (this.previousPageItem != null) {
            if (this.page <= 1) {
                setItem(this.previousPageSlot, this.previousPageItem.apply(1), e -> {});
            } else {
        ...
        if (this.nextPageItem != null) {
            if (this.page >= lastPage) {
                setItem(this.nextPageSlot, this.nextPageItem.apply(lastPage), e -> {});
            } else {
